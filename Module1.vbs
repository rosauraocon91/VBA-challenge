    ...
    For Each ws In Worksheets
        ...
        'msgBox ('Last row in column A is " & LastRowA)
            ...
            For i = 2 To LastRowA
                ...
                'Write ticker column i (#9)
                ws.Cells(TickCount, 9).Value = ws.Cells(i, 1).Value
                
                'Calculate and Write Yearly Changge in column j (#10)
                ws.Cells(TickCount, 10).Value = ws.Cells(i, 6).Value - ws.Cells(j, 3).Value
                    ...
                    'Ser cell background Color to Green
                ...
                'Calculate and Write total colume in column L (#12)
                ws.Cells(TickCount, 12).Value = WorksheetFunction.Sum(Range(ws.Cells(j, 7), ws.Cells(i, 7)))
                
                'Increase TickCount by 1
                TickCount = TickCount + 1
                
                'Ser new start row of the Ticker Block
                j = i + 1
        ...
        GreatDecr = ws.Cells(2, 11).Value
            ...
            For i = 2 To LastRowI
                ...
                'For greatest total volume--check if nexr value is larger--if yes takeover a new value and populate ws.Cells
                If ws.Cells(i, 12).Value > GreatVol Then
                GreatVol = ws.Cells(i, 12).Value
                ws.Cells(4, 16).Value = Value = ws.Cells(i, 9).Value
                ...
                'For Greates decrease--check if next value is smaller--if yes take over a new value and populate ws.Cells
